var arr=[
    {name:'prayam', image:'https://images.unsplash.com/photo-1426543881949-cbd9a76740a4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGNvdXBsZSUyMGFuaW1lfGVufDB8fDB8fHww'},
...
function searchfunctionality(){
    var data=document.querySelector("#searchinput");
...
data.addEventListener('input',function(){
   if(data.value !=""){
    const input=arr.filter(obj=>obj.name.toLowerCase().startsWith(data.value));
    var clutter="";
